...
Smart Fridge — приложение для учета продуктов, импорта позиций из чеков и писем, определения срока годности по базе знаний и уведомлений о приближающемся истечении срока.
...
Если уже есть контейнер PostgreSQL, создайте БД и пользователя или укажите существующие значения в `.env`:
